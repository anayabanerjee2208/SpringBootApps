...
public class GradeBookControllerTest {
    ...
    public static void setup(){
        ...
        request.setParameter("emailAddress", "anaya.banerjee@gmail.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        student.setFirstname("TestUser1");
        student.setLastname("TestLastName1");
        student.setEmailAddress("anaya.banerjee@gmail.com");
    ...
    public void createStudentHttpRequestTest() throws Exception {
        ...
        CollegeStudent collegeStudent = studentDao.findByEmailAddress("anaya.banerjee@gmail.com");
        assertNotNull(collegeStudent, "Student should be valid");
    }
